...
FILEPATH: /c:/xx/appTest/aseApp2.bicep
...
resource sitesResource 'Microsoft.Web/sites@2022-03-01' = {
  ...
  properties: {
    ...
    serverFarmId: sitesServerfarmsAspId 
    reserved: true
    isXenon: false
    hyperV: false
...
var workspaceId = contains(sitesLocation,'westus3')? amerworkspaceId : contains(sitesLocation,'southeastasia')? apacworkspaceId : emeaworkspaceId
